...
| --- | --- | --- |
| `GET` | `/api/v1/abstract-templates` | List abstract templates and their custom-field schema. |
| `POST` | `/api/v1/abstracts` | Create an abstract, with optional document files. |
